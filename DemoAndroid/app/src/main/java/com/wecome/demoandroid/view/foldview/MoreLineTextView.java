package com.wecome.demoandroid.view.foldview;
...
public class MoreLineTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void initWithAttrs(AttributeSet attrs) {
        if (isInEditMode()) {
            ...
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.MoreLineTextView);
            mTextColor = typedArray.getColor(R.styleable.MoreLineTextView_textColor, ContextCompat.getColor(getContext(), R.color.gray));
            mTextSize = typedArray.getDimension(R.styleable.MoreLineTextView_textSize, UiUtil.sp2px(14));
            mMaxLine = typedArray.getInt(R.styleable.MoreLineTextView_maxLine, DEFAULT_MAX_LINES);
            mExpandDrawable = typedArray.getDrawable(R.styleable.MoreLineTextView_expandIcon);
            mDurationMillis = typedArray.getInt(R.styleable.MoreLineTextView_durationMillis, DEFAULT_ANIM_TIME);
            mClickAll = typedArray.getBoolean(R.styleable.MoreLineTextView_clickAll, false);
