...
public class SettingPageModel extends ListModel{
...
//    }
    ...
    public SettingPageModel(int leftText, int leftImgResId, int id) {
        super(leftText, leftImgResId, id);
    }

    public SettingPageModel(int leftText, int id) {
        super(leftText, 0, id);
    }
