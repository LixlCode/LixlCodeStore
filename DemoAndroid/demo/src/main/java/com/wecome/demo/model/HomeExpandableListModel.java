...
public class HomeExpandableListModel {
    ...
    public HomeExpandableListModel(int leftText, int leftImgResId, int id) {
        this.leftText = leftText;
        this.leftImgResId = leftImgResId;
        this.id = id;
    }
    public HomeExpandableListModel(int leftText, int id) {
        this.leftText = leftText;
        this.id = id;
    }
